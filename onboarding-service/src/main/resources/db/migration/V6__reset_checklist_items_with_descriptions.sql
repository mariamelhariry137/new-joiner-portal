...
INSERT INTO checklist_items (title, description, order_index) VALUES
    ...
    ('Complete HR paperwork', 'Fill out and submit all required HR forms and paperwork.', 3),
    ('Review the company handbook', 'Read through the company handbook to understand policies, culture, and expectations.', 4);
